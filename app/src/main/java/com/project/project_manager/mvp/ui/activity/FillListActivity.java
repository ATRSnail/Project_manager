 ...
 * 归档列表
 */
public class FillListActivity extends BaseRefreshActivity implements BaseQuickAdapter.OnRecyclerViewItemClickListener
    ...
    public void onItemClick(View view, int i) {
        startActivity(new Intent(mActivity, LinkActivity.class));
    }
