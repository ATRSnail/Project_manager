...
public class SimpleImageAdapter extends CommonAdapter<String> {
    ...
    public SimpleImageAdapter(ViewGroup container, boolean isDelete, int rowCount, int containerWidth) {
        super(container.getContext(), null, R.layout.activity_gradview_item);
    ...
    public SimpleImageAdapter(ViewGroup container, boolean isDelete, int rowCount, int containerWidth, DelImgListener delImgListener) {
        super(container.getContext(), null, R.layout.activity_gradview_item);
        this.containerWidth = containerWidth;
        this.isDelete = isDelete;
        this.rowCount = rowCount;
    ...
    public void convert(final ViewHolder holder, final String data) {
        ...
        if (isDelete) {
            ...
            ivDelete.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View v) {
                    if (delImgListener != null && data.contains("http")) {
                        delImgListener.delImg(data);
                    } else {
                        //移除图片
                        mDatas.remove(data);
